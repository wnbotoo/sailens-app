...
dependencyResolutionManagement {
    ...
    // This edition consumes Core Edition's version catalog on purpose: AGP, Kotlin and the
...
// Core Edition as a composite build. At settings top level, not inside pluginManagement: this is
